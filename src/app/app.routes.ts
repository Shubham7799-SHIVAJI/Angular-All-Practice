...
export const routes: Routes = [
    ...
    {component:Home,path:''},
    {component:SellerAuth,path:'seller-auth'},
    {component:SellerHome,path:'seller-home', canActivate:[authGuard]},
    {component:SellerAddProduct,path:'seller-add-product', canActivate:[authGuard]},];
